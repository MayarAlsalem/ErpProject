...
{
    public partial class ERP1R82Context : DbContext
    {
        public ERP1R82Context()
        {
        }

        public ERP1R82Context(DbContextOptions<ERP1R82Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-C8ILDH2\\SQLEXPRESS;Initial Catalog=ERP1R82;Persist Security Info=True;User ID=sa;Password=123456789");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Ev>(entity =>
            {
                ...
                entity.Property(e => e.CoPr).HasMaxLength(25);
                ...
                entity.HasOne(d => d.CoPrNavigation)
                    .WithMany(p => p.Ev)
                    .HasForeignKey(d => d.CoPr)
                    .HasConstraintName("FK_Ev_Pr");

                entity.HasOne(d => d.IdEvRefNavigation)
                    .WithMany(p => p.Ev)
                    .HasForeignKey(d => d.IdEvRef)
                    .HasConstraintName("FK_Ev_EvRef");

                entity.HasOne(d => d.IdPeNavigation)
                    .WithMany(p => p.Ev)
                    .HasForeignKey(d => d.IdPe)
                    .HasConstraintName("FK_Ev_Pe");
            });
            ...
            modelBuilder.Entity<PeEv>(entity =>
            {
                ...
                entity.HasOne(d => d.IdEvNavigation)
                    .WithMany(p => p.PeEv)
                    .HasForeignKey(d => d.IdEv)
                    .HasConstraintName("FK_PeEv_Ev");
